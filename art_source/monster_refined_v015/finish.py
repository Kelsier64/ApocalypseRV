"""Export v015 with unchanged v011 packed 2K textures and all 23 clips."""
import bpy
...
rig.name='Raker_Rig'
try:
    bpy.ops.export_scene.gltf(filepath=OUT+'raker_refined_v015.glb',use_selection=True,use_active_scene=True,
    ...
    mesh.name='Refined015_Mesh'
    rig.name='Refined015_Rig'
...
bpy.ops.wm.save_as_mainfile(filepath=OUT+'monster_refined_v015.blend')
print('FINISHED',OUT)

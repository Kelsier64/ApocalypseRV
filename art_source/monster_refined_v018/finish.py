"""Export v018 with unchanged v011 packed 2K textures and all 41 clips."""
import bpy
from mathutils import Vector
OUT='C:/Users/evan4/Projects/ApocalypseRV/art_source/monster_refined_v018/'
scene=bpy.data.scenes['MONSTER_REFINED_V018']
bpy.context.window.scene=scene
rig=bpy.data.objects['Refined018_Rig']
mesh=bpy.data.objects['Refined018_Mesh']
...
rig.name='Raker_Rig'
try:
    bpy.ops.export_scene.gltf(filepath=OUT+'raker_refined_v018.glb',use_selection=True,use_active_scene=True,
    ...
    mesh.name='Refined018_Mesh'
    rig.name='Refined018_Rig'

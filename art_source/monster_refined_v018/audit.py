...
OUT=Path('C:/Users/evan4/Projects/ApocalypseRV/art_source/monster_refined_v018')
s=bpy.data.scenes['MONSTER_REFINED_V018'];bpy.context.window.scene=s
r=bpy.data.objects['Refined018_Rig'];m=bpy.data.objects['Refined018_Mesh']

"""Export v019 with unchanged v011 packed 2K textures and all 41 clips."""
import bpy
from mathutils import Vector
OUT='C:/Users/evan4/Projects/ApocalypseRV/art_source/monster_refined_v019/'
scene=bpy.data.scenes['MONSTER_REFINED_V019']
bpy.context.window.scene=scene
rig=bpy.data.objects['Refined019_Rig']
mesh=bpy.data.objects['Refined019_Mesh']
...
rig.name='Raker_Rig'
try:
    bpy.ops.export_scene.gltf(filepath=OUT+'raker_refined_v019.glb',use_selection=True,use_active_scene=True,
    ...
    mesh.name='Refined019_Mesh'
    rig.name='Refined019_Rig'
...
bpy.ops.wm.save_as_mainfile(filepath=OUT+'monster_refined_v019.blend')
print('FINISHED',OUT)

"""Export v017 with unchanged v011 packed 2K textures and all 41 clips."""
import bpy
from mathutils import Vector
OUT='C:/Users/evan4/Projects/ApocalypseRV/art_source/monster_refined_v017/'
...
rig.name='Raker_Rig'
try:
    bpy.ops.export_scene.gltf(filepath=OUT+'raker_refined_v017.glb',use_selection=True,use_active_scene=True,
...
bpy.ops.wm.save_as_mainfile(filepath=OUT+'monster_refined_v017.blend')
print('FINISHED',OUT)

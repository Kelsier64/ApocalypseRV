"""Export rebuilt hands, packed 2K body + 1K hand atlases, 54 bones and 41 clips."""
import bpy
from mathutils import Vector
OUT='C:/Users/evan4/Projects/ApocalypseRV/art_source/monster_refined_v021/'
scene=bpy.data.scenes['MONSTER_REFINED_V021']
bpy.context.window.scene=scene
rig=bpy.data.objects['Refined021_Rig']
mesh=bpy.data.objects['Refined021_Mesh']
...
rig.name='Raker_Rig'
try:
    bpy.ops.export_scene.gltf(filepath=OUT+'raker_refined_v021.glb',use_selection=True,use_active_scene=True,
    ...
    mesh.name='Refined021_Mesh'
    rig.name='Refined021_Rig'
...
bpy.ops.wm.save_as_mainfile(filepath=OUT+'monster_refined_v021.blend')
print('FINISHED',OUT)
